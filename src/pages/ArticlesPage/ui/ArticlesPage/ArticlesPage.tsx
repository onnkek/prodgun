...
const articles = [
  {
    ...
    user: {
      id: '1',
      username: 'admin',
      avatar: 'https://img.freepik.com/premium-photo/sute-girl-hacker-with-laptop-avatar-cartoon-style-black-background-generated-ai_88188-3324.jpg?w=900'
    },
    "type": [ArticleType.IT],
    "blocks": [
      {
  ...
  {
    "id": "5",
    "title": "Lorem ipsum very nice info  2024",
    "subtitle": "",
    "img": "https://etzq49yfnmd.exactdn.com/wp-content/uploads/2022/03/cicero_gradient.png?strip=all&lossy=1&ssl=1",
    "views": 1022,
    "createdAt": "24.05.2024",
    "type": [ArticleType.ECONOMICS, ArticleType.SCIENCE, ArticleType.IT, , ArticleType.SCIENCE],
    user: {
      id: '1',
      username: 'admin',
      avatar: 'https://img.freepik.com/premium-photo/sute-girl-hacker-with-laptop-avatar-cartoon-style-black-background-generated-ai_88188-3324.jpg?w=900'
...
const ArticlesPage = ({ className }: ArticlesPageProps) => {
  ...
  return (
    <div className={classNames(cls.articlesPage, {}, [className])}>
      <ArticleList articles={articles} view={ArticleView.LIST} isLoading/>
    </div>
  );
};
